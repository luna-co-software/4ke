      ...
      parameters(*this, nullptr, "SSL4KEQ", createParameterLayout())
{
    ...
    #ifdef JucePlugin_Build_LV2
    // Initialize LV2 inline display
    lv2InlineDisplay = std::make_unique<LV2InlineDisplay>(this);
    #endif
}

SSL4KEQ::~SSL4KEQ() = default;

//==============================================================================
juce::AudioProcessorValueTreeState::ParameterLayout SSL4KEQ::createParameterLayout()
{
...
//==============================================================================
void SSL4KEQ::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
bool SSL4KEQ::isBusesLayoutSupported(const BusesLayout& layouts) const
{
...
//==============================================================================
void SSL4KEQ::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
void SSL4KEQ::updateHPF(double sampleRate)
{
...
void SSL4KEQ::updateLPF(double sampleRate)
{
...
void SSL4KEQ::updateLFBand(double sampleRate)
{
...
void SSL4KEQ::updateLMBand(double sampleRate)
{
...
void SSL4KEQ::updateHMBand(double sampleRate)
{
...
void SSL4KEQ::updateHFBand(double sampleRate)
{
...
float SSL4KEQ::calculateDynamicQ(float gain, float baseQ) const
{
...
float SSL4KEQ::applySaturation(float sample, float amount) const
{
...
//==============================================================================
void SSL4KEQ::getStateInformation(juce::MemoryBlock& destData)
{
...
void SSL4KEQ::setStateInformation(const void* data, int sizeInBytes)
{
...
//==============================================================================
juce::AudioProcessorEditor* SSL4KEQ::createEditor()
{
    return new SSL4KEQEditor(*this);
}
...
extern "C" {
    // Forward declaration from LV2InlineDisplay.cpp
    const void* ssl4keq_extension_data(const char* uri);

    // Export extension data function for LV2
    LV2_SYMBOL_EXPORT
    const void* lv2_descriptor_extension_data(const char* uri)
    {
        return ssl4keq_extension_data(uri);
    }
}
#endif