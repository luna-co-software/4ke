...
SSLLookAndFeel::SSLLookAndFeel()
{
    ...
    highlightColour = juce::Colour(0xff00b4d8);     // SSL signature blue
                                       ...
                                       juce::Slider& slider)
{
    ...
    // SSL-style pointer line (white with subtle glow)
    juce::Path pointer;
...
void SSLLookAndFeel::drawScaleMarkings(juce::Graphics& g, float cx, float cy, float radius,
...
void SSLLookAndFeel::drawValueReadout(juce::Graphics& g, juce::Slider& slider,
...
void SSLLookAndFeel::drawLinearSlider(juce::Graphics& g, int x, int y, int width, int height,
...
void SSLLookAndFeel::drawToggleButton(juce::Graphics& g, juce::ToggleButton& button,
...
void SSLLookAndFeel::drawComboBox(juce::Graphics& g, int width, int height, bool isButtonDown,
...
juce::Font SSLLookAndFeel::getComboBoxFont(juce::ComboBox&)
{
    return juce::Font(juce::FontOptions(11.0f).withStyle("Bold"));
}

juce::Font SSLLookAndFeel::getLabelFont(juce::Label&)
{
    return juce::Font(juce::FontOptions(10.0f).withStyle("Bold"));
}

void SSLLookAndFeel::drawLabel(juce::Graphics& g, juce::Label& label)
{
